...
object MessageKey {
    ...
    const val DATA_NOT_FOUND: String = "exception.data_not_found"
    ...
    const val EXCEPTION_NULL_POINTER: String = "exception.null_pointer"
    const val BIDDING_RULE_EXCEPTION: String = "bid.exception.bidding_rule_error"
    const val INTERNAL_SERVER_ERROR: String = "exception.internal_server_error"
    const val EXCEPTION_INVALID_API_PATH_VARIABLE: String = "exception.invalid_api_path_variable"
    const val EXCEPTION_MALFORMED_DATA: String = "exception.malformed_data"
    const val EXCEPTION_MALFORMED_BEHAVIOUR: String = "exception.malformed_behaviour"
    const val EXCEPTION_DATA_INTEGRITY_VIOLATION: String = "exception.data_integrity_violation"
    const val FEEDBACK_EXCEPTION: String = "feedback.exception"
    const val EXCEPTION_BAD_CREDENTIALS: String = "exception.bad_credentials"
    const val EXCEPTION_PERMISSION_DENIED: String = "permission.permission_denied"
    const val EXCEPTION_KOI_REVOKE: String = "exception.koi_revoke"
    const val EXCEPTION_DELETE_ERROR: String = "exception.delete_error"
    const val EXCEPTION_UNAUTHORIZED: String = "exception.unauthorized"
}
