(function(window, document, $, undefined) {
    ...
    const axilInit = {
        ...
        scrollSmooth: function (e) {
            $(document).on('click', '.smooth-animation', function (event) {
        ...
        shopFilterWidget: function() {
            $('.toggle-list > .title').on('click', function(e) {
                ...
                const target = $(this).parent().children('.shop-submenu');
            ...
            $('.toggle-btn').on('click', function(e) {
                ...
                const target = $(this).parent().siblings('.toggle-open');
                const target2 = $(this).parent();
                $(target).slideToggle();
                $(target2).toggleClass('active');
            });
        ...
        mobileMenuActivation: function(e) {
            ...
            $('.menu-item-has-children > a').on('click', function(e) {
                ...
                const targetParent = $(this).parents('.header-main-nav');
                const target = $(this).siblings('.axil-submenu');
        ...
        axilSlickActivation: function(e) {
            ...
            const $slideStatus = $('.slick-slide-count');
        ...
        countdownInit: function(countdownSelector, countdownTime) {
            const eventCounter = $(countdownSelector);
        ...
        stickyHeaderMenu: function() {
            ...
            $(window).on('scroll', function() {
                ...
                if ($('body').hasClass('sticky-header')) {
                    const stickyPlaceHolder = $('#axil-sticky-placeholder'),
                        menu = $('.axil-mainmenu'),
                        menuH = menu.outerHeight(),
                        topHeaderH = $('.axil-header-top').outerHeight() || 0,
                        headerCampaign = $('.header-top-campaign').outerHeight()
                            || 0,
        ...
        headerCampaignRemove: function() {
           $('.remove-campaign').on('click', function() {
                const targetElem = $('.header-top-campaign');
